...
class CifarModel(object):
  ...
  def _build_graph(self, images, labels, mode):
    ...
    #   self.saver = tf.train.import_meta_graph(self.hparams.class_model)
...
#     self.hparams = hparams
#
#     self.model_dir = os.path.join(hparams.class_model)
#     self.log_dir = os.path.join(hparams.class_model, 'log')
